...
| 来店需要と必要人員 | 曜日・時間帯別の予測来店数 |
| --- | --- |
| ![時間帯別の需要予測と推奨人員](outputs/staffing_by_hour.png) | ![曜日・時間帯別の予測来店数](outputs/demand_heatmap.png) |
| 店舗・時間帯別の人員過不足 | 店舗別の標準業務時間構成 |
| ![店舗・時間帯別の人員過不足](outputs/staff_gap_heatmap.png) | ![店舗別の標準業務時間構成](outputs/task_minutes_by_store.png) |
...
- `outputs/`: 名寄せ結果、推奨人員、過不足分析、4種類のグラフ
