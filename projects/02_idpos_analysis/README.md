...
| チラシ掲載候補 | RFM顧客区分の構成 |
| --- | --- |
| ![チラシ掲載候補](outputs/flyer_candidates.png) | ![RFM顧客区分の構成](outputs/rfm_segment_distribution.png) |
| カテゴリ別売上構成 | 店舗別の曜日売上構成比 |
| ![カテゴリ別売上構成](outputs/category_sales.png) | ![店舗別の曜日売上構成比](outputs/store_weekday_heatmap.png) |
...
- `data/`: 合成した取引明細・商品マスタ
- `outputs/`: 顧客区分、商品評価、販促候補、4種類のグラフ
