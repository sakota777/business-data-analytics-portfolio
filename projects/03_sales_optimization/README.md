...
| 見込みスコア帯別の契約率 | 流入経路別の契約率 |
| --- | --- |
| ![見込みスコア帯別の契約率](outputs/conversion_by_score.png) | ![流入経路別の契約率](outputs/conversion_by_source.png) |
| 営業接触回数と契約率 | 営業優先度別の顧客数と契約率 |
| ![営業接触回数と契約率](outputs/conversion_by_contacts.png) | ![営業優先度別の顧客数と契約率](outputs/priority_performance.png) |
