...
| 広告流入から契約までのファネル | チャネル別の転換率 |
| --- | --- |
| ![広告流入から契約までのファネル](outputs/funnel.png) | ![チャネル別の転換率](outputs/channel_conversion.png) |
| 月次ファネル推移 | 有料チャネル別の獲得単価 |
| ![月次ファネル推移](outputs/monthly_funnel_trend.png) | ![有料チャネル別の獲得単価](outputs/channel_acquisition_cost.png) |
